...
export default function PVAsTab({
  ...
  const canReadPVAProductSupplies = checkScope(ModelType.INSUMO_PVA_PRODUCTO, ScopeType.READ);
  ...
  useEffect(() => {
    void loadPVAs();
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [targetProductoBaseId, targetMateriaPrimaId, canReadPVAProduct]);
  ...
  const handleCrearProcesoYAgregar = async () => {
    ...
    if (!canWriteAddedValueProcess || !canWritePVAProduct) {
      toast.permissionError(
        [ModelType.PROCESO_VALOR_AGREGADO, ScopeType.WRITE],
        [ModelType.PVA_PRODUCTO, ScopeType.WRITE]
      );
  ...
  const toggleExpand = async (pvaId) => {
    ...
    if (!canReadPVAProductSupplies) {
      toast.permissionError([ModelType.INSUMO_PVA_PRODUCTO, ScopeType.READ]);
      return;
    }
              ...
              <div className="border rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-2 items-end">
                  ...
                  <button
                    ...
                    disabled={loading || !canReadPVAProduct}
                  >
                    Agregar
                  </button>
                </div>
                  ...
                  <div className="mt-3 border rounded-lg p-3 bg-gray-50">
                    ...
                    <div className="mt-3 flex justify-end gap-2">
                      ...
                      <button
                        ...
                        disabled={creandoProceso || loading || !canWriteAddedValueProcess || !canWritePVAProduct}
                      >
                        Crear y agregar
                      </button>
                    </div>
                          ...
                          <div className="flex items-start justify-between gap-3 flex-wrap">
                            ...
                            <div className="flex gap-2 flex-wrap">
                              <button
                                ...
                                disabled={loading || idx === 0 || !canWritePVAProduct}
                                title="Subir"
                              >
                                ↑
                              </button>
                              <button
                                ...
                                className="px-3 py-2 border rounded-lg hover:bg-gray-50"
                                onClick={() => handleReordenarSwap(idx, idx + 1)}
                                disabled={loading || idx === pvas.length - 1 || !canWritePVAProduct}
                                title="Bajar"
                              >
                                ↓
                              </button>
                              ...
                              <button
                                ...
                                disabled={loading || !canDeletePVAProduct}
                              >
                                Eliminar
                              </button>
                            </div>
