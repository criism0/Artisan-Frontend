/**
 * Buscar en LibreDTE un documento emitido FUERA del ERP y vincularlo a este proceso — tarea #108.
 *
 * EL CASO REAL. Una guía de despacho emitida a mano en el panel de LibreDTE para un traslado
 * que en el ERP es una solicitud, o una factura de una OV emitida desde el portal del SII, queda
 * «en el aire»: consumió un folio y en el sistema no le corresponde nada. Acá se busca ese
 * documento y se dice a qué proceso pertenece.
 *
...
export default function BuscadorDteExterno({ idOrdenVenta, idSolicitud, onCancelar, onSuccess }) {
  ...
  return (
    <div>
      {/* 🔴 El aviso va ARRIBA y siempre visible, no en letra chica al final: es lo que distingue
          vincular de facturar, y confundirlos haría creer que el inventario se movió. */}
