...
export default function CostosIndirectosTab({
  ...
  const recetaCostosList = Array.isArray(recetaCostos) ? recetaCostos : [];

  return (
    <div className="space-y-4">
      <div className="bg-white p-6 rounded-lg shadow">
        <div className="text-sm font-semibold text-gray-800 mb-1">Costos indirectos</div>
        <div className="text-sm text-gray-600 mb-4">
          Asocia costos indirectos como referencia <span className="font-semibold">$/kg</span> a la receta.
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          {/* Columna izquierda: Selección/creación */}
          <div className="border rounded-lg p-4 space-y-4">
            <div>
              <div className="text-sm font-semibold text-gray-800 mb-2">Asociar costo indirecto a receta (por kg)</div>
            ...
            <div className="border-t pt-4">
              <div className="text-sm font-semibold text-gray-800 mb-2">Crear nuevo costo indirecto</div>
