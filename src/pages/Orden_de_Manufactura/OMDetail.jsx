  ...
  useEffect(() => {
    ...
    const fetchInsumos = async () => {
      try {
        ...
        const todosAsignados = registros.length > 0 && registros.every((insumo) => {
    ...
    <div className="p-6 max-w-4xl mx-auto bg-white rounded shadow">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-2xl font-bold ml-4">
          Detalle de Orden de Manufactura
        </h1>
      </div>
      ...
      <div className="bg-gray-50 rounded-lg p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div>
            ...
            <p className="text-gray-800">{om.receta?.nombre || om.id_receta}</p>
          </div>
          <div>
          ...
          <div>
            <span className="font-medium text-gray-600">Bodega:</span>
            <p className="text-gray-800">{om.bodega?.nombre || om.id_bodega}</p>
          </div>
          <div>
          ...
          <div>
            <span className="font-medium text-gray-600">Peso Objetivo:</span>
            <p className="text-gray-800">{om.peso_objetivo} kg</p>
          </div>
          {om.estado === "Cerrada" && (
            <div>
              <span className="font-medium text-gray-600">Peso Obtenido:</span>
              <p className="text-gray-800">{om.peso_obtenido} kg</p>
            </div>
          )
          }
          ...
          <div>
            ...
            <p className="text-gray-800">${om.receta.costo_referencial_produccion}</p>
          </div>
          <div>
            <span className="font-medium text-gray-600">Costo Total:</span>
            <p className="text-gray-800">${om.costo_total}</p>
          </div>
          {om.estado === "Cerrada" && (
            <div>
              <span className="font-medium text-gray-600">Rendimiento:</span>
              <p className="text-gray-800">{((om.peso_obtenido / om.peso_objetivo) * 100).toFixed(2)}%</p>
            </div>
          )}
      ...
      <div className="mt-8 flex flex-wrap gap-4">
        {estado === "Borrador" && !insumosAsignados && (
          <button
        ...
        <div className="bg-yellow-50 rounded-lg p-6 mt-8">
          ...
          <table className="w-full bg-white rounded-lg overflow-hidden">
            <thead className="bg-yellow-100">
              <tr>
                <th className="text-left px-4 py-3 text-sm font-medium text-yellow-800">
                  Producto
                </th>
                <th className="text-left px-4 py-3 text-sm font-medium text-yellow-800">
                  Peso (kg)
            ...
            <tbody>
              {productosFinales.map((prod) => (
                <tr key={prod.id} className="border-b border-yellow-100">
