...
export default function EditPautaValorAgregado() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      if (!canReadInProgress || !canReadAddedValueGuideline || !canReadAddedValueProcess || !canReadPVAProduct) {
    ...
    fetchData();
  }, [api, id, canReadInProgress, canReadAddedValueGuideline, canReadAddedValueProcess]);
    ...
    <div className="p-6 bg-background min-h-screen">
      ...
      <div className="flex justify-end mt-8">
        <button
          ...
          disabled={!canWriteAddedValueGuideline}
