...
export default function OrdenVentaDetail() {
  ...
  return (
    <div className="p-6 bg-background min-h-screen">
      ...
      {/* Panel DTE — Documentos Tributarios Electrónicos
          Tracer bullet: muestra los botones de emisión según el estado de la orden.
          Cuando el backend DTE esté implementado, los DTEs emitidos se cargarán desde
          GET /api/dte/ordenes/:id/documentos y los botones llamarán a la API real. */}
