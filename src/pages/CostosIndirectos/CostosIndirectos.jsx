...
export default function CostosIndirectos() {
        ...
        Cell: ({ row }) => (
          <div className="flex items-center gap-2 justify-end">
            ...
            <button
              ...
              disabled={row.is_active === false || !canDeleteIndirectCost}
  ...
  if (isLoading) return <PageLoader message="Cargando costos indirectos" />;
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm mb-6">
        ...
        <div className="flex justify-end mt-3">
          <button
            ...
            disabled={isCreating || !canWriteIndirectCost}
          >
        ...
        <div className="space-y-3">
          ...
          <div className="flex justify-end gap-2 pt-2">
            ...
            <button
              ...
              disabled={isSavingEdit || !canWriteIndirectCost}
            >
